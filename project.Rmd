...
#plot adj r2
par(mfrow = c(1, 2))
plot(r2_fr$K, r2_fr$adj_r2, type = "l", ylim = c(0, 1))
plot(r2_fr$K, r2_fr$adj_r2, type = "l")
```
...
plot(x = 1:125, y = trend_pred, type = "l", main = "main trend 125 days prediction", ylab = "price", xlab = "days after data ends")
```
...
plot(x = 1:125, y = seasonal_pred, type = "l", main = "seasonal trend 125 days prediction", ylab = "price", xlab = "days after data ends")
```
```{r}
#smooth component prediction
smooth = trend_pred + seasonal_pred
plot(x = 1:125, y = smooth, type = "l", main = "smooth component 125 days prediction", ylab = "prediction", xlab = "days after data ends")
```
```{r}
...
lower_80 = rough_pred$lower[,1]             
upper_80 = rough_pred$upper[,1]             
lower_95 = rough_pred$lower[,2]             
upper_95 = rough_pred$upper[,2]    
...
```{r}
final_pred <- trend_pred + seasonal_pred + point_forecast
plot(final_pred, type="l", main = "final 125 days prediction", ylab = "prediction", xlab = "days after data ends")
```
